...
const Hero = () => {
  return (
    <div className="h-[75vh] flex flex-col md:flex-row items-center justify-center px-4 md:px-0">
      ...
      <div className="w-full h-auto lg:h-[100%] flex justify-center mt-8 md:mt-0">
